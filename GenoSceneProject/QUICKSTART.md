...
افتح `genoscene.html` في متصفحك للوصول إلى الواجهة التفاعلية.

Open `genoscene.html` in your browser to access the interactive interface.
...
- `genoscene.html` - الواجهة التفاعلية الرئيسية
